...
extension Color {
    ...
    enum Input {
        ...
        enum Background {
            ...
            /// The "Input/Background/Disabled" color.
            @available(*, deprecated)
            static let disabled = Color(
                light: UIColor(0x121314, alpha: 0.04), dark: UIColor(0xF6F8FB, alpha: 0.04)
            )
        ...
        enum Border {
            ...
            /// The "Input/Border/Disabled" color.
            @available(*, deprecated)
            static let disabled = Color(
                light: .clear, dark: UIColor(0xF6F8FB, alpha: 0.04)
            )
        ...
        enum Placeholder {
            ...
            /// The "Input/Placeholder/Disabled" color.
            @available(*, deprecated)
            static let disabled = Color(
                light: UIColor(0xA7A9AF), dark: UIColor(0x707378)
            )
