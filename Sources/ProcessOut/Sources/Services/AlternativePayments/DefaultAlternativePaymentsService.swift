...
final class DefaultAlternativePaymentsService: POAlternativePaymentsService {
    ...
    ) async throws(POFailure) -> POAlternativePaymentResponse {
    ...
    func url(for request: POAlternativePaymentTokenizationRequest) throws(POFailure) -> URL {
    ...
    func url(for request: POAlternativePaymentAuthorizationRequest) throws(POFailure) -> URL {
    ...
    @available(*, deprecated)
    func alternativePaymentMethodResponse(url: URL) throws(POFailure) -> POAlternativePaymentMethodResponse {
    ...
    private func response(from url: URL) throws(POFailure) -> POAlternativePaymentResponse {
        guard let components = URLComponents(url: url, resolvingAgainstBaseURL: true) else {
            let message = "Invalid or malformed alternative payment method URL response provided."
