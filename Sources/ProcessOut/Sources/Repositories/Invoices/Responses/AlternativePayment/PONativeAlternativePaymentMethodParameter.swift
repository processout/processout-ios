...
public struct PONativeAlternativePaymentMethodParameter: Codable, Sendable {

    public enum ParameterType: String, Codable, Hashable, Sendable {
    ...
    public struct AvailableValue: Codable, Hashable, Sendable {
