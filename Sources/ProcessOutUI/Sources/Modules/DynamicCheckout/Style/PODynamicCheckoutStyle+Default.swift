...
extension PODynamicCheckoutStyle {
    ...
    public static let `default` = PODynamicCheckoutStyle(
        ...
        inputTitle: POTextStyle(color: Color(.Text.primary), typography: .label1),
        input: .medium,
        codeInput: .large,
        radioButton: PORadioButtonStyle.radio,
        bodyText: POTextStyle(color: Color(.Text.primary), typography: .body1),
        errorText: POTextStyle(color: Color(.Text.error), typography: .label2),
        message: .toast,
...
extension PODynamicCheckoutStyle.RegularPaymentMethod {
    ...
    public static let `default` = Self(
        title: POTextStyle(color: Color(.Text.primary), typography: .subheading),
        informationText: POTextStyle(color: Color(.Text.muted), typography: .body2),
        border: POBorderStyle.regular(color: Color(.Border.subtle))
    )
}
...
extension PODynamicCheckoutStyle.PaymentSuccess {
    ...
    public static let `default` = Self(
        message: POTextStyle(color: Color(.Text.success), typography: .body1),
