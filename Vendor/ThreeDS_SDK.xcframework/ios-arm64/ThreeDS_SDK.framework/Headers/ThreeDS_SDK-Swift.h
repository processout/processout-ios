...
///
/// \param additionalParameters Additional configuration parameters. For future use.
///
///
/// throws:
/// InvalidInput, SDKNotInitialized, SDKRuntime.
- (id <NCATransaction> _Nullable)createTransactionWithDirectoryServerId:(NSString * _Nonnull)directoryServerId messageVersion:(NSString * _Nullable)messageVersion additionalParameters:(NSDictionary<NSString *, NSString *> * _Nullable)additionalParameters error:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
