...
/// A  case for environment which connects to qa.
/// :nodoc:
  Checkout3DSEnvironmentSandboxOffline = 2,
/// A  case for the environment which connects to the sandbox offline slice.
/// :nodoc:
  Checkout3DSEnvironmentProductionOffline = 3,
/// A  case for the environment which connects to the production offline slice.
/// :nodoc:
  Checkout3DSEnvironmentQa = 4,
/// A  case for environment which connects to local.
/// :nodoc:
  Checkout3DSEnvironmentLocal = 5,
/// :nodoc:
  Checkout3DSEnvironmentCertification = 6,
};
